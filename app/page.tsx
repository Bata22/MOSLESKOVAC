    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[#001530] via-[#002d63] to-[#001530] py-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          <h1 className="font-display text-7xl sm:text-9xl text-white leading-none tracking-wide mb-6">
            Međuokružni odbojkaški  <br />
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {CATEGORIES.map(cat => (
            <Link key={cat.value} href={`/timovi?kategorija=${cat.value}`}
              ...
              <div className="font-display text-4xl text-white tracking-widest group-hover:text-[#f5c518] transition-colors mb-2">
      ...
      <footer className="bg-[#001530] border-t border-[#003f8a]/40 py-8 text-center">
        ...
        <p className="text-blue-500 text-xs">Kreirao: Bratislav Nikolić  </p>
